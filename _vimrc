...
func SetTitle() 
    ...
    if &filetype == 'sh' 
        ...
        call append(line("."), "#########################################################################") 
        call append(line(".")+1, "# Author: neofung(http://blog.neofung.org/)") 
        ...
        call setline(1, "/*************************************************************************") 
        call append(line("."), " Author: neofung(http://blog.neofung.org/)") 
        call append(line(".")+1, " Created Time: ".strftime("%FT%T%z")) 
