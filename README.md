...
* [OmniCppComplete](http://github.com/vim-scripts/OmniCppComplete) - C/C++ omni-completion with ctags database.

In Unix or Mac, I use these.

 * [YouCompleteMe](http://github.com/Valloric/YouCompleteMe) - A code-completion engine for Vim .
...
You can select use YouCompleteMe for code-completion, And YCM requires Clang. For more information, visit [YouCompleteMe](http://github.com/Valloric/YouCompleteMe).
